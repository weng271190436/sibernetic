...
if [[ ($# -eq 1) && ($1 == '-all') ]]; then
    ...
    python sibernetic_c302.py -test -duration 5 -dt 0.005 -dtNrn 0.05 -logstep 100 -device=CPU -configuration worm_crawl_half_resolution -reference FW -c302params C2 -datareader UpdatedSpreadsheetDataReader2
