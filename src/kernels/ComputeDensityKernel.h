...
inline ComputeDensityMetalArgs toMetalArgs(const ComputeDensityInput &input,
                                           MTL::Device *device,
...
inline ComputeDensityOpenCLArgs toOpenCLArgs(const ComputeDensityInput &input,
                                             cl::Context &context,
                                             cl::Buffer &outputRho) {
